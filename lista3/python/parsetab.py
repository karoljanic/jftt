...
_lr_productions = [
  ...
  ('line -> expression EOL','line',2,'p_line_expression','calc_parser.py',21),
  ('line -> error EOL','line',2,'p_line_error','calc_parser.py',34),
  ('line -> EOL','line',1,'p_line_eol','calc_parser.py',43),
  ('expression -> NUM','expression',1,'p_expression_num','calc_parser.py',47),
  ('expression -> L_BRA expression R_BRA','expression',3,'p_expression_parent','calc_parser.py',54),
  ('expression -> expression ADD expression','expression',3,'p_expression_add','calc_parser.py',58),
  ('expression -> expression SUB expression','expression',3,'p_expression_sub','calc_parser.py',64),
  ('expression -> expression MUL expression','expression',3,'p_expression_mul','calc_parser.py',70),
  ('expression -> expression DIV expression','expression',3,'p_expression_div','calc_parser.py',76),
  ('expression -> SUB expression','expression',2,'p_expression_neg','calc_parser.py',86),
  ('expression -> expression POW exponent','expression',3,'p_expression_pow','calc_parser.py',93),
  ('exponent -> NUM','exponent',1,'p_exponent_num','calc_parser.py',99),
  ('exponent -> L_BRA exponent R_BRA','exponent',3,'p_exponent_parent','calc_parser.py',106),
  ('exponent -> exponent ADD exponent','exponent',3,'p_exponent_add','calc_parser.py',110),
  ('exponent -> exponent SUB exponent','exponent',3,'p_exponent_sub','calc_parser.py',116),
  ('exponent -> exponent MUL exponent','exponent',3,'p_exponent_mul','calc_parser.py',122),
  ('exponent -> exponent DIV exponent','exponent',3,'p_exponent_div','calc_parser.py',128),
  ('exponent -> SUB exponent','exponent',2,'p_exponent_neg','calc_parser.py',138),
]
